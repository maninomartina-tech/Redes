...
export const seedAds: Ad[] = [
  ...
  },
  {
    ...
    clientId: 'cli_flora',
    platform: 'facebook',
    name: 'Promo desayuno · Fin de semana',
    objective: 'Más visitas al perfil',
    status: 'finalizada',
    dailyBudget: 1200,
    days: 15,
    budget: 18000,
  ...
  },
  {
    ...
    clientId: 'cli_demm',
    platform: 'instagram',
    name: 'Carrusel de errores comunes',
...
export const seedMonthlyStats: MonthlyStat[] = [
  ...
  { id: 'ms_a6', clientId: 'cli_demm', month: monthBack(6), followers: 2010, views: 11200, nonFollowerViews: 6800, interactions: 890, reach: 9400, profileVisits: 610 },
  { id: 'ms_a5', clientId: 'cli_demm', month: monthBack(5), followers: 2290, views: 14900, nonFollowerViews: 9600, interactions: 1180, reach: 12800, profileVisits: 820 },
  { id: 'ms_a4', clientId: 'cli_demm', month: monthBack(4), followers: 2680, views: 18400, nonFollowerViews: 12300, interactions: 1520, reach: 16100, profileVisits: 1040 },
  { id: 'ms_a3', clientId: 'cli_demm', month: monthBack(3), followers: 3120, views: 22600, nonFollowerViews: 15700, interactions: 1840, reach: 19700, profileVisits: 1290 },
  { id: 'ms_a2', clientId: 'cli_demm', month: monthBack(2), followers: 3640, views: 28100, nonFollowerViews: 20400, interactions: 2210, reach: 24300, profileVisits: 1580 },
  { id: 'ms_a1', clientId: 'cli_demm', month: monthBack(1), followers: 4180, views: 31800, nonFollowerViews: 23900, interactions: 2510, reach: 27600, profileVisits: 1830 },

  // Flora Café — arrancó en 3120
  { id: 'ms_f4', clientId: 'cli_flora', month: monthBack(4), followers: 3340, views: 9800, nonFollowerViews: 4100, interactions: 640, reach: 8200 },
  { id: 'ms_f3', clientId: 'cli_flora', month: monthBack(3), followers: 3610, views: 12400, nonFollowerViews: 5600, interactions: 810, reach: 10400 },
  { id: 'ms_f2', clientId: 'cli_flora', month: monthBack(2), followers: 3980, views: 15600, nonFollowerViews: 7400, interactions: 1020, reach: 13100 },
  { id: 'ms_f1', clientId: 'cli_flora', month: monthBack(1), followers: 4310, views: 18900, nonFollowerViews: 9200, interactions: 1240, reach: 15800 },

  // Nova Fitness — cuenta nueva, arrancó en 420
  { id: 'ms_n2', clientId: 'cli_nova', month: monthBack(2), followers: 610, views: 3600, nonFollowerViews: 2500, interactions: 210, reach: 3100 },
  { id: 'ms_n1', clientId: 'cli_nova', month: monthBack(1), followers: 890, views: 6300, nonFollowerViews: 4700, interactions: 380, reach: 5400 },
];
